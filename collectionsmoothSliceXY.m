function [newDirs] = collectionsmoothSliceXY(fractions, dirs, kernel, cutoff, iters, slice)
% Smooths the orientations in 'dirs' along a single slice.
% This method uses an approximation where the weights are precalculated
% 
% from:
