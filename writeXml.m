...
disp(['writing vol of size: ', num2str(dim), ' to: ', xmlfile]);
...
typemap = {'Double','double'; 'Float','float'; 'Integer','int'; ...
    'Float','short';'Byte', 'schar'; 'Long', 'long';...
    'Unsigned Integer', 'uint32';'Unsigned Short', 'ushort'; 'Unsigned Short', 'uint16';
    'Unsigned Byte', 'uint8'; 'Integer', 'int32'; 'Float','single'; ...
    };
